...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { session_id: @voter.session_id, zip_id: @voter.zip_id } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { session_id: @voter.session_id, zip_id: @voter.zip_id } }
