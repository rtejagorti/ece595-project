...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { division_num: @division.division_num, division_type: @division.division_type, precinct_id: @division.precinct_id } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { division_num: @division.division_num, division_type: @division.division_type, precinct_id: @division.precinct_id } }
